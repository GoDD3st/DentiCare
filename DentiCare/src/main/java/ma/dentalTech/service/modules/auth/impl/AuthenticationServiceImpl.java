...
import ma.dentalTech.common.consoleLog.ConsoleLogger;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public AuthenticationServiceImpl() {
        this.utilisateurRepo = ApplicationContext.getBean(UtilisateurRepo.class);
    }
    ...
    public void logout(UserPrincipal principal) {
        ...
        ConsoleLogger.info("Déconnexion de l'utilisateur: " + principal.nom() + " (" + principal.login() + ")");
