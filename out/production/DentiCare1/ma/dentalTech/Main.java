...
import ma.dentalTech.service.modules.auth.impl.AuthenticationServiceImpl;
...
public class Main {
    public static void main(String[] args) {
        ...
        UtilisateurRepo utilisateurRepo = new UtilisateurRepoImpl();
        AuthenticationService authenticationService = new AuthenticationServiceImpl(utilisateurRepo);
